...
namespace Settings {
    ...
    constexpr byte display[][Settings::DISPLAY_ROWS] = {
        ...
        {0x0, 0x2, 0x2, 0x2, 0x2, 0x2, 0x0, 0x0},  // Number 1
        ...
        {0x0, 0x0, 0x4, 0x0, 0x4, 0x0, 0x0, 0x0},  // Full-colon :
 ...
 public:
  ...
  void displayTime() {
    ...
    for (int i{0}; i < fieldsToDisplay; ++i) {
      ...
      mappedChars[index++] = digitsToDisplay % 10;  // Digit at ones position
      mappedChars[index++] =
          (digitsToDisplay / 10) % 10;  // Digit at tens position
 ...
 public:
  ...
  void readDatetime() {
    Wire.beginTransmission(
        DS1307_ADDRESS);          // Start I2C protocol with DS1307 address
